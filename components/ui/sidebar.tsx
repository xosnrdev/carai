...
import { runtimePropsMap, sidebarProps } from '@/lib/constants/ui'
...
const Sidebar: FC = () => {
    ...
    const [selectedRuntime, setSelectedRuntime] = useState<RuntimeProp | null>(
        null
    )
    ...
    const filteredRuntimes = useMemo(() => {
        ...
        const sortedRuntimeProps = Array.from(runtimePropsMap.entries())
            .slice()
    ...
    const handleChange = (value: string) => {
        const parsedValue = JSON.parse(value) as RuntimeProp
    ...
    const handleClick = useCallback(() => {
        return new Promise<void>((resolve, reject) => {
            ...
            try {
                ...
                reject(new CustomError((error as Error).message))
            }
        })
