	...
	return (
		<section className="prose prose-lg mx-auto grid min-h-screen max-w-prose place-content-center dark:prose-invert">
			...
			<blockquote className="font-normal not-italic">
				<strong className="mb-4 block text-xl">OK.</strong>
				<small className="text-base">
					If you think this shouldn&apos;t happen, you can help us fix this
					error by sending us a bug report to our{' '}
					<Link
